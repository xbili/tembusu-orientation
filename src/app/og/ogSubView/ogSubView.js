...
.controller( 'OGSubViewCtrl', function OGSubViewController( $scope ) {
  ...
  $scope.ogInfo = {
    ...
    "merfolk":{
      ...
      "by":"The Four-Chambered Heart, Anaïs Nin",
    ...
    "yeti":{
      ...
      "by":"The Girl Who Soared Over Fairyland and Cut the Moon in Two, Catherynne M. Valente",
    ...
    "phoenix":{
      "quote":"And made the glove-winged albatross Scour the ashes of the sea Where Capricorn and Zero cross, A brooding immortality— Such as the charmed phoenix has In the unwithering tree.",
      "by":"Genesis, Geoffrey Hill",
    ...
    "vampire":{
      "quote":"As he spoke he smiled, and the lamplight fell on a hardlooking mouth, with very red lips and sharp-looking teeth, as white as ivory. One of my companions whispered to another the line from Bürger's Lenore. ‘Denn die Todten reiten Schnell.’ (‘For the dead travel fast.’)",
      ...
      "headOGL": "amirul",
      "ogls": ["rebecca", "hai jin"]
    },
    "basilisk":{
      "quote":"Be thou like the imperial Basilisk. Killing thy foe with unapparent wounds.Gaze on Oppression, till at that dread risk. Aghast she pass from the Earth’s disk. Fear not, but gaze—for freemen mightier grow, And slaves more feeble, gazing on their foe:— If Hope, and Truth, and Justice may avail, Thou shalt be great—All hail!",
      "by":"Ode to Naples, Percy Bysshe Shelley",
    ...
    "goblin":{
      "quote":"We must not look at goblin men, We must not buy their fruits: Who knows upon what soil they fed Their hungry thirsty roots?",
      "by":"Goblin Market and Other Poems, Christina Rossetti",
    ...
    "hippogriff":{
      "quote":"But natural was the steed the wizard pressed; For him a filly to griffin bore; Hight hippogryph. In wings and beak and crest, Formed like his sire, as in the feet before; But like the mare, his dam, in all the rest. Such on Riphaean hills, though rarely found, Are bred, beyond the frozen ocean's bound.",
      "by":"Orlando Furioso, Ludovico Ariosto",
